...
(function () {
  ...
  if (masonryGrid) {
    ...
    const imageMeta = [
      { id: '3 maasai jumping',  cat: 'portrait',  title: 'Untitled Portrait I' },
      { id: '4 maasai women',  cat: 'landscape', title: 'Nairobi Skyline' },
      { id: '4 maasais abstract',  cat: 'abstract',  title: 'Form Study III' },
      { id: '7 maasai abstract',  cat: 'portrait',  title: 'Dignity Series II' },
      { id: 'buffalo',  cat: 'landscape', title: 'Rift Valley Dawn' },
      { id: 'elephant & wildbeats',  cat: 'abstract',  title: 'Colour & Chaos' },
      { id: 'elephnt & river',  cat: 'portrait',  title: 'Elders I' },
      { id: 'hometown',  cat: 'landscape', title: 'Savannah Light' },
      { id: 'kilmanjaro & bird',  cat: 'abstract',  title: 'Weave Structure' },
      { id: 'lion & river', cat: 'portrait',  title: 'Maasai Grace' },
      { id: 'lomon', cat: 'landscape', title: 'Coastal Blue' },
      { id: 'manyattah homelife', cat: 'abstract',  title: 'Geometry IV' },
      { id: 'mufasa monkey', cat: 'portrait',  title: 'Elders II' },
      { id: 'mum & child monkey', cat: 'landscape', title: 'Mount Kenya Dawn' },
      { id: 'rhino', cat: 'abstract',  title: 'Density Study' },
      { id: 'smiling lady', cat: 'portrait',  title: 'Youth Series I' },
      { id: 'smiling maasai lady', cat: 'landscape', title: 'Lake Turkana' },
      { id: 'sneakers', cat: 'abstract',  title: 'Ripple Effect' },
      { id: 'thinking', cat: 'portrait',  title: 'Dignity Series III' },
      { id: 'ugly beauty', cat: 'landscape', title: 'Amboseli Dusk' },
      { id: 'village kid', cat: 'abstract',  title: 'Line Study VII' },
      { id: 'young lady', cat: 'portrait',  title: 'Urban Voices' },
      { id: 'zebra head', cat: 'landscape', title: 'Lamu Waterfront' },
      { id: 'smiling lady', cat: 'abstract',  title: 'Texture Field' },
    ];
